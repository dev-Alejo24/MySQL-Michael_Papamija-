...
CREATE TABLE shift (
    ...
    `description` TINYTEXT,
    idUser INT,
    FOREIGN KEY (idUser) REFERENCES users(id), -- Corrección de referencia
    createdAt DATETIME DEFAULT CURRENT_TIMESTAMP,
    updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE paymentDetail (
    ...
    idCustomer INT,
    FOREIGN KEY (idCustomer) REFERENCES people(id), -- Corregida la referencia a people
...
CREATE TABLE invoices (
    ...
    idCustomer INT,
    FOREIGN KEY (idCustomer) REFERENCES people(id),
    createdAt DATETIME DEFAULT CURRENT_TIMESTAMP,
    updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
