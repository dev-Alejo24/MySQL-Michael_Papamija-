...
CREATE TABLE `payment_detail` (
  ...
  CONSTRAINT `payment_detail_ibfk_1` FOREIGN KEY (`idCustomer`) REFERENCES `users_roles` (`id`),
  CONSTRAINT `payment_detail_ibfk_2` FOREIGN KEY (`idPaymentMethod`) REFERENCES `payment_method` (`id`)
